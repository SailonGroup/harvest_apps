...
--
-- Table structure for table `full_soa_app_clients`
--

DROP TABLE IF EXISTS `full_soa_app_clients`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `full_soa_app_clients` (
...
--
-- Dumping data for table `full_soa_app_clients`
--

LOCK TABLES `full_soa_app_clients` WRITE;
/*!40000 ALTER TABLE `full_soa_app_clients` DISABLE KEYS */;
/*!40000 ALTER TABLE `full_soa_app_clients` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `full_soa_app_invoice_payments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `full_soa_app_invoice_payments` (
  `id` bigint(20) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `full_soa_app_invoice_payments_invoice-id_idx` (`invoice-id`),
  CONSTRAINT `full_soa_app_invoice_payments_invoice-id` FOREIGN KEY (`invoice-id`) REFERENCES `full_soa_app_invoices` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `full_soa_app_invoice_payments`
--

LOCK TABLES `full_soa_app_invoice_payments` WRITE;
/*!40000 ALTER TABLE `full_soa_app_invoice_payments` DISABLE KEYS */;
/*!40000 ALTER TABLE `full_soa_app_invoice_payments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `full_soa_app_invoices`
--

DROP TABLE IF EXISTS `full_soa_app_invoices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `full_soa_app_invoices` (
  `id` bigint(20) NOT NULL,
  ...
  KEY `full_soa_app_invoices_client-id_idx` (`client-id`),
  CONSTRAINT `full_soa_app_invoices_client-id` FOREIGN KEY (`client-id`) REFERENCES `full_soa_app_clients` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `full_soa_app_invoices`
--

LOCK TABLES `full_soa_app_invoices` WRITE;
/*!40000 ALTER TABLE `full_soa_app_invoices` DISABLE KEYS */;
/*!40000 ALTER TABLE `full_soa_app_invoices` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `full_soa_app_settings`
--

DROP TABLE IF EXISTS `full_soa_app_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `full_soa_app_settings` (
...
--
-- Dumping data for table `full_soa_app_settings`
--

LOCK TABLES `full_soa_app_settings` WRITE;
/*!40000 ALTER TABLE `full_soa_app_settings` DISABLE KEYS */;
INSERT INTO `full_soa_app_settings` VALUES ('harvest_password','password','2014-01-01 00:00:00'),('harvest_subdomain','contosogroup','2014-01-01 00:00:00'),('harvest_username','example@contosogroup.com','2014-01-01 00:00:00'),('last_run_utc',NULL,'2014-01-01 00:00:00');
/*!40000 ALTER TABLE `full_soa_app_settings` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `full_soa_app_template_settings`
--

DROP TABLE IF EXISTS `full_soa_app_template_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `full_soa_app_template_settings` (
