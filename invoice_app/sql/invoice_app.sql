...
--
-- Table structure for table `invoice_app_clients`
--

DROP TABLE IF EXISTS `invoice_app_clients`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invoice_app_clients` (
...
--
-- Dumping data for table `invoice_app_clients`
--

LOCK TABLES `invoice_app_clients` WRITE;
/*!40000 ALTER TABLE `invoice_app_clients` DISABLE KEYS */;
/*!40000 ALTER TABLE `invoice_app_clients` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `invoice_app_invoice_line_items`
--

DROP TABLE IF EXISTS `invoice_app_invoice_line_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `invoice_app_invoice_line_items`
--

LOCK TABLES `invoice_app_invoice_line_items` WRITE;
/*!40000 ALTER TABLE `invoice_app_invoice_line_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `invoice_app_invoice_line_items` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `invoice_app_invoices`
--

DROP TABLE IF EXISTS `invoice_app_invoices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invoice_app_invoices` (
  `id` bigint(20) NOT NULL,
  ...
  KEY `invoice_app_invoices_client-id_idx` (`client-id`),
  CONSTRAINT `invoice_app_invoices_client-id` FOREIGN KEY (`client-id`) REFERENCES `invoice_app_clients` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `invoice_app_invoices`
--

LOCK TABLES `invoice_app_invoices` WRITE;
/*!40000 ALTER TABLE `invoice_app_invoices` DISABLE KEYS */;
/*!40000 ALTER TABLE `invoice_app_invoices` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `invoice_app_settings`
--

DROP TABLE IF EXISTS `invoice_app_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `invoice_app_settings`
--

LOCK TABLES `invoice_app_settings` WRITE;
/*!40000 ALTER TABLE `invoice_app_settings` DISABLE KEYS */;
INSERT INTO `invoice_app_settings` VALUES ('harvest_password','password','2014-01-01 00:00:00'),('harvest_subdomain','contosogroup','2014-01-01 00:00:00'),('harvest_username','example@contosogroup.com','2014-01-01 00:00:00'),('last_run_utc',NULL,'2014-01-01 00:00:00');
/*!40000 ALTER TABLE `invoice_app_settings` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `invoice_app_template_settings`
--

DROP TABLE IF EXISTS `invoice_app_template_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invoice_app_template_settings` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `invoice_app_template_settings`
--

LOCK TABLES `invoice_app_template_settings` WRITE;
/*!40000 ALTER TABLE `invoice_app_template_settings` DISABLE KEYS */;
INSERT INTO `invoice_app_template_settings` VALUES (1,'Street Name\nLocality Postcode\nCountry','true','Amount','Amount Due','before','%d/%m/%Y','Description','Discount','Due Date','For','From','false','false','true','false','true','true','Request for Payment','Request for Payments','REQUEST FOR PAYMENT','Request for Payment ID','<b>Line 1</b>\n<i>Line 2</i>\nLine 3','Issue Date','Contoso Group','Notes','Payments','Page [page] of [toPage]','PO Number','Quantity','true','true','Subject','Subtotal','VAT','Tax2','Total Payments','Type','Unit Price','Upon Receipt');
/*!40000 ALTER TABLE `invoice_app_template_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-09-08 19:48:17
